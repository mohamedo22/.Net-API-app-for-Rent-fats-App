...
namespace test.Migrations
{
    ...
    [Migration("20250612122609_firstMig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("test.Model.ContactUsRequest", b =>
                {
            ...
            modelBuilder.Entity("test.Model.ContactUsRequest", b =>
                {
                    b.HasOne("test.Model.Flat", "Flat")
                        .WithOne("ContactUsRequest")
                        .HasForeignKey("test.Model.ContactUsRequest", "FlatCodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("test.Model.User", "User")
                        .WithOne("ContactUsRequest")
                        .HasForeignKey("test.Model.ContactUsRequest", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("test.Model.Flat", b =>
                {
                    b.Navigation("ContactUsRequest")
                        .IsRequired();

                    b.Navigation("FlatImages");

                    b.Navigation("FlatImagesDocs");
                });
